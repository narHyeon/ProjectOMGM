				...
				<div>
					...
					<span id="memberTable_drop" class="dropdown mb-4">
						<button class="btn btn-info dropdown-toggle" type="button"
							...
							aria-haspopup="true" aria-expanded="false">검색조건</button> <span
						class="dropdown-menu animated--fade-in"
						aria-labelledby="dropdownMenuButton"> <a
							class="dropdown-item" href="#" onClick="selectBox(event)">회원번호</a>
							<a class="dropdown-item" href="#" onClick="selectBox(event)">ID</a>
							<a class="dropdown-item" href="#" onClick="selectBox(event)">이름</a>
					</span>
					</span>
					<%--  드롭박스  --%>
					<input type="text" onkeyup="filter()" id="memberTable_search"
						placeholder="이름으로 검색" class="form-control bg-light border-0 small">
				</div>
