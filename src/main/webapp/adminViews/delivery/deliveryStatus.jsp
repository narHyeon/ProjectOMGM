    ...
    <div id="deliveryStatus">
        <div class="box-numberInfo">
            ...
            <input type="text" class = "box-inputText" name="paramInvcNo" value=""
                   placeholder="‘–’를 제외한 숫자만 입력해주세요" title="택배 조회 - 운송장 번호 ‘–’를 제외한 숫자만 입력해주세요"
        ...
        <div class="box01">
            ...
            <div class="right-box01">
                <p class="right-box01-p" style="color: blue">상담 운영시간</p>
                    월~금요일 09:00~18:00 / 토요일 09:00~13:00<br> 상품의 파손,
                변질에 의한 택배 사고 접수는<p style="color: blue; margin-top:2%; margin-bottom: -1%">1:1</p> 문의를 통해 직접 하실 수 있습니다.
            </div>
        </div>
    </div>
</body>
