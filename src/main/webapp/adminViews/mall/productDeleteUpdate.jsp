...
<body>
	...
	<div id="productDeleteUpdate_main_div"
		...
		<div
			...
			<a href="productInquiryToy.mdo"><button class="btn btn-info">장난감
					현왕 페이지로 이동</button></a>
		</div>
		<form method="post" name="productDeleteUpdate_form"
			...
			<div id="productDeleteUpdate_section_div00"
				...
				<div id="productDeleteUpdate_img_div"
					...
					<img name="" style="vertical-align: center; width: 90%;"
						src="resources/img/product/${mallToyOne.toy_img}"> <input
			...
			<div class="inputArea">
				...
				<textarea name="toy_info" rows="10" cols="100"
					id="productDeleteUpdate_Intro_inputText" style="resize: none;">${mallToyOne.toy_info}</textarea>
			</div>
