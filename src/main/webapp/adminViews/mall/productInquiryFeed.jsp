	...
	<div id="productInquiry_searchbox">
		...
		<div class="container">
			<span class="name01">장난감 이미지</span> <span class="name01">장난감
				...
				가격</span> <span class="name01">장난감 할인가</span> <span class="name01">장난감
				제고</span>
			<c:forEach var="feedList" items="${feedList}">
				<div class="item">
					...
					<span class="name">d - ${feedList.feed_expiration}</span> <span
						class="name">${feedList.feed_price}원</span> <span class="name">${feedList.feed_discount}원</span>
