...
<nav
	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow mx-1">
			...
			<div id="admin_chatting" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${member.id}(${member.name})</span>
...
<script src="resources/admin/js/header/header.js"></script>
