...
<ul
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="buttons.html">공지사항/이벤트</a> <a
					class="collapse-item" href="cards.html">이용후기</a> <a
					class="collapse-item" href="cards.html">프로모션</a> <a
					class="collapse-item" href="cards.html">고객센터</a>
			</div>
		</div></li>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapseUtilities" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="utilities-color.html">HOTEL 회원</a> <a
					class="collapse-item" href="utilities-border.html">MALL 회원</a> <a
					class="collapse-item" href="utilities-animation.html">관리자 목록</a> <a
					class="collapse-item" href="utilities-other.html">기타 관리</a>
			</div>
		</div></li>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-expanded="true" aria-controls="collapsePages"> <i
			class="fas fa-fw fa-folder"></i> <span>HOTEL</span>
	</a>
		<div id="collapsePages" class="collapse"
			aria-labelledby="headingPages" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">호텔:</h6>
				<a class="collapse-item" href="login.html">호텔 예약</a> <a
				...
				<a class="collapse-item" href="register.html">유치원 예약</a> <a
					...
					class="collapse-item" href="blank.html">유치원 정산</a>
				<div class="collapse-divider"></div>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapsePages2" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item" href="login.html">상품등록</a> <a
					class="collapse-item" href="register.html">상품조회</a> <a
					class="collapse-item" href="forgot-password.html">상품등록</a>
				<div class="collapse-divider"></div>
				<h6 class="collapse-header">판매:</h6>
				<a class="collapse-item" href="404.html">주문조회</a> <a
					class="collapse-item" href="404.html">배송현황</a> <a
					class="collapse-item" href="blank.html">교환</a> <a
					class="collapse-item" href="blank.html">반품</a>
				<div class="collapse-divider"></div>
				<h6 class="collapse-header">관리:</h6>
				<a class="collapse-item" href="blank.html">MALL 정산</a> <a
					class="collapse-item" href="blank.html">문의/리뷰</a>
			</div>
		</div></li>
