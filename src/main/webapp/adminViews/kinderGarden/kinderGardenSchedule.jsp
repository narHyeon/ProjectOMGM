...
<body>
	<div class="card mb-4 py-3 border-bottom-info">
		<div class="card-body">유치원 시간표 관리</div>
	</div>
	<div>
		...
		<div class="admin_kindergarden_schedule_pm">
			<input id="admin_kindergarden_schedule_title" type="text"
				placeholder="저장할 이름을 입력" class="form-control form-control-user"
				value="${day.title}">
		...
		<div class="admin_kindergarden_schedule_button">
			<a href="#" class="btn btn-info btn-user"
				onclick="window.location.reload()">초기화</a> <a href="login.html"
				class="btn btn-success btn-user ">적용</a>
		</div>
	</div>
