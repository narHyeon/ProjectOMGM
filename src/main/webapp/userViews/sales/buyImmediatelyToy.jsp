...
<%--                <input id="buyImmediatelyDivSection07Address02" style="margin-top: 1.5%; width: 50%; height: 30px;" type="text" placeholder="상세주소" />--%>
        ...
        <div id="buyImmediatelyDivSection02">
            ...
            <div id="buyImmediatelyDivSection02_05" style="display: flex; justify-content: center; margin-top: 5%; padding-top: 5%; align-items: center;" ><button onclick="kakaoPayToy()" style="color: white; height: 55px; width: 75px; border-radius: 20%; background-color: deeppink; border: none;">구매하기</button></div>
            <div>
                <script>
                    //수량 가져오기
                    ...
                    var QuantityFeed1 = getParameterByName("toy_Quantity");
                    // 결제
                    function kakaoPayToy() {
                        ...
                        if(buyI05Name==="" || buyI06Phone==="" || buyI07Zipcode==="" || buyI07Address01===""){
                            ...
                            $(function () {
                                ...
                                var buyerPointLeft = ${member.point} - document.getElementById("buyImmediatelyDivSection02_01_02Use").innerHTML+${toyInfo.toy_point};
                                var buyerPointUsed = document.getElementById("buyImmediatelyDivSection02_01_02Use").innerHTML;
                                // swal(buyerZipCode + " "+buyerAddress + " " + buyerName +" "+ buyerPointUsed);
                                IMP.request_pay({
                                    ...
                                    if (rsp.success) {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: "insertOrderImmediately.do", //cross-domain error가 발생하지 않도록 주의해주세요
                                            dataType: 'json',
                                        ...
                                        //실패시 이동할 페이지
                                        location.href = "getMallToyList.do";
                                        swal(msg);
                                    }
                                });
...
<script>
    ...
    document.getElementById("buyImmediatelyDivSection03Left01TotalPrice").innerHTML="할인 적용 금액 : " + ${toyInfo.toy_discount}*QuantityFeed;
    document.getElementById("buyImmediatelyDivSection03Left01DiscountPrice").innerHTML="할인 금액 : " + ${toyInfo.toy_price-toyInfo.toy_discount}*QuantityFeed;
    document.getElementById("buyImmediatelyDivSection02_01_02BeforePrice").innerHTML= ${toyInfo.toy_price}*QuantityFeed;
    document.getElementById("buyImmediatelyDivSection02_01_02DiscountPrice").innerHTML= ${toyInfo.toy_price-toyInfo.toy_discount}*QuantityFeed;
    document.getElementById("buyImmediatelyDivSection02_01_02Price").innerHTML=${toyInfo.toy_price}*QuantityFeed-${toyInfo.toy_price-toyInfo.toy_discount}*QuantityFeed;
    // 우편번호 체크
