...
<link type="text/css" rel="stylesheet"
	href="resources/style/sales/toySales.css">
<!-- <script src="//code.jquery.com/jquery-3.3.1.min.js" defer></script> -->
<script type="text/javascript" src="resources/js/sales/toySales.js"
	defer></script>
</head>
<body>
	<div id="toy-sales-div">
		...
		<div id="toy-sales-section">
			<div class="toy-sales-section00">냥이 장난감</div>
			<div class="toy-sales-section01">54,900원</div>
			<div class="toy-sales-section02">
				<p class="toy-delieve-price-text">배송비 : 2,500원 (50,000원 이상 구매 시
					무료)</p>
			</div>
			<div class="toy-sales-section03">
				<p class="toy-type-text">타입을 선택하세요</p>
				<select id="toy-sales-option" name="toy-sales-option"
					onchange="changeToySelect()">
			...
			<div class="toy-sales-section07">
				<a href="#" class="byt-immediately00">즉시 구매하기</a> <a href="#"
					class="byt-immediately01">장바구니 담기</a>
			</div>
			<div class="toy-sales-section08">
				<a class="toy-sales-coupon"> 2,000원 즉시 할인쿠폰 받기 </a>
			</div>
			<div class="toy-sales-section09">
				<script src="https://nsp.pay.naver.com/sdk/js/naverpay.min.js"
					...
					data-merchant-pay-key="가맹점 주문 번호" data-product-name="상품명을 입력하세요"
					data-total-pay-amount="1000" data-tax-scope-amount="1000"
