...
#textareastyle{border: 1px solid #FFABB9; padding:0.5%; margin-right:1%; margin-left:1%; width:100%; height:100%;}
</style>
			...
			<form action="updateMyPet.do" method="post">
				<div class="bar">
					...
					<div class="bar-content">
						<input id="inputstyle" type="text" name="pet_kind" value="${mypetpage.PET_KIND}">
					</div>
				</div>
				<div class="bar">
					<div class="bar-title">종류의종류</div>
					<div class="bar-content">
						<input id="inputstyle" type="text" name="pet_variety" value="${mypetpage.PET_VARIETY}">
					</div>
				</div>
				<div class="bar">
					<div class="bar-title">나이</div>
					<div class="bar-content">
						<input id="inputstyle" type="text" name="pet_name" value="${mypetpage.PET_NAME}">
					</div>
				</div>
				<div class="bar">
					<div class="bar-title">이름</div>
					<div class="bar-content">
						<input id="inputstyle" type="text" name="pet_age" value="${mypetpage.PET_AGE}">
					</div>
				</div>
				<div class="bar">
					<div class="bar-title">성별</div>
					<div class="bar-content">
						<input id="inputstyle" type="text" name="pet_gender" value="${mypetpage.PET_GENDER}">
					</div>
				</div>
				<div id="bar4">특이사항
					<div id="bar-content6">
				...
				<div id="bottom">
					<input type="submit" value="수 정 완 료" class="buttons">
