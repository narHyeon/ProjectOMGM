...
#qna_row{display:flex; flex-direction: column; margin-left:2%;}
...
<div id="qna_wrap">
	<h1 id="qna_head">Q and A</h1>
		...
		<div id="check"><p id="align_text">글 번호</p></div>
		 <div id="check2"><p id="align_text_content">제 목</p></div>  
		 <div id="check3"><p id="align_text">날짜</p></div> 
		 <div id="check4"><p id="align_text">추가</p></div>
...
<div id="ex1" class="modal">
	...
	<div id="m-wrap">
	 ...
	 <input type="button" value="완료" onclick="insertTag()" class="buttons" ></a>
