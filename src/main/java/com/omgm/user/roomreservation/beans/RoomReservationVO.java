...
public class RoomReservationVO {
	...
	public String toString2() {
		return "RoomReservationVO [ROOMRESERVATION_NO=" + ROOMRESERVATION_NO + ", ROOMRESERVATION_ROOMNO="
				+ ROOMRESERVATION_ROOMNO + ", ROOMRESERVATION_ROOMPRICE=" + ROOMRESERVATION_ROOMPRICE
				+ ", ROOMRESERVATION_ROOMNAME=" + ROOMRESERVATION_ROOMNAME + ", ROOMRESERVATION_MEMBERNO="
				+ ROOMRESERVATION_MEMBERNO + ", ROOMRESERVATION_STAYDAY=" + ROOMRESERVATION_STAYDAY
				+ ", ROOMRESERVATION_STRSTAYDAY=" + ROOMRESERVATION_STRSTAYDAY + ", ROOMRESERVATION_PAYDAY="
				+ ROOMRESERVATION_PAYDAY + ", ROOMRESERVATION_FOODNO=" + ROOMRESERVATION_FOODNO
				+ ", ROOMRESERVATION_FOODNAME=" + ROOMRESERVATION_FOODNAME + ", ROOMRESERVATION_TOYNO="
				+ ROOMRESERVATION_TOYNO + ", ROOMRESERVATION_TOYNAME=" + ROOMRESERVATION_TOYNAME
				+ ", ROOMRESERVATION_PICKUPYN=" + ROOMRESERVATION_PICKUPYN + ", ROOMRESERVATION_PICKUPTIME="
				+ ROOMRESERVATION_PICKUPTIME + ", ROOMRESERVATION_PICKUPADDRESS=" + ROOMRESERVATION_PICKUPADDRESS
				+ ", ROOMRESERVATION_PICKUPPHONENUM=" + ROOMRESERVATION_PICKUPPHONENUM + ", ROOMRESERVATION_USEPOINTYN="
				+ ROOMRESERVATION_USEPOINTYN + ", ROOMRESERVATION_USEPOINT=" + ROOMRESERVATION_USEPOINT
				+ ", ROOMRESERVATION_PLUSPOINT=" + ROOMRESERVATION_PLUSPOINT + ", ROOMRESERVATION_FIANLFEE="
				+ ROOMRESERVATION_FIANLFEE + ", ROOMRESERVATION_NOWDATE=" + ROOMRESERVATION_NOWDATE + "]";
	}
	@Override
	public String toString() {
		return "RoomReservationVO [ROOMRESERVATION_NO=" + ROOMRESERVATION_NO + ", ROOMRESERVATION_ROOMNO="
				...
				+ ROOMRESERVATION_USEPOINTYN + ", ROOMRESERVATION_USEPOINT=" + ROOMRESERVATION_USEPOINT
				+ ", ROOMRESERVATION_PLUSPOINT=" + ROOMRESERVATION_PLUSPOINT + ", ROOMRESERVATION_FIANLFEE="
				+ ROOMRESERVATION_FIANLFEE + ", ROOMRESERVATION_NOWDATE=" + ROOMRESERVATION_NOWDATE + ", MEMBER_SEQ="
				+ MEMBER_SEQ + ", MEMBER_ID=" + MEMBER_ID + ", MEMBER_NAME=" + MEMBER_NAME + ", MEMBER_PHONE="
				+ MEMBER_PHONE + ", MEMBER_ADDRESS=" + MEMBER_ADDRESS + ", MEMBER_POINT=" + MEMBER_POINT
				+ ", MEMBER_RANK=" + MEMBER_RANK + ", ROOM_NO=" + ROOM_NO + ", ROOM_NAME=" + ROOM_NAME
				+ ", ROOM_CONTENT=" + ROOM_CONTENT + ", ROOM_IMG=" + ROOM_IMG + ", ROOM_PRICE=" + ROOM_PRICE
				+ ", ROOM_SALERATE=" + ROOM_SALERATE + ", ROOM_KIND=" + ROOM_KIND + ", ROOM_RANK=" + ROOM_RANK
				+ ", ROOM_FOR=" + ROOM_FOR + "]";
	}
