...
public class RoomReservationVO_M {
	...
	//해당 예약에대한 냥박일지
	private List<CatCareLogVO_M> catCareList;
	...
	public List<CatCareLogVO_M> getCatCareList() {
		return catCareList;
	}

	public void setCatCareList(List<CatCareLogVO_M> catCareList) {
		this.catCareList = catCareList;
	}
}
